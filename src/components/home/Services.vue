      ...
      <div class="p-[8px] sm:p-[12px]">
        <div class="px-[42px] py-[58px] bg-white rounded-[32px]">
          ...
          <p class="text-base mt-[16px] max-w-[270px]">
            Rainbow helps you boost your recurring revenue, including upsells,
            cross-sells, upgrades, and unique subscription options.
          </p>
        </div>
      </div>
      <div class="p-[8px] sm:p-[12px]">
        <div class="px-[42px] py-[58px] bg-white rounded-[32px]">
          ...
          <p class="text-base mt-[16px] max-w-[270px]">
            Your entire business operation can be up and running in a matter of
            days. Rainbow takes care of everything from filing paperwork
          </p>
        </div>
      </div>
      <div class="p-[8px] sm:p-[12px]">
        <div class="px-[42px] py-[58px] bg-white rounded-[32px]">
          ...
          <p class="text-base mt-[16px] max-w-[270px]">
            Sell locally while preventing fraud, handling chargebacks, and
            adhering with all current and new regulations.
          </p>
        </div>
      </div>
    </div>
