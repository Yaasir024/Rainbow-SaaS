  ...
  <section class="px-[25px] xs:px-[40px] md:px-[70px] 2xl:pl-[150px] mb-[280px] pt-[150px] xs:pt-0">
    ...
    <div class="section-1 flex mt-[20px] w-full">
      <div class="hidden xs:block">
        <button class="h-[36px] w-[36px] bg-[#62E4FF] rounded-full flex items-center justify-center ml-[-18px]">
          <img src="@/assets/images/home/products/lighting-charge.svg" alt="" class="" />
        </button>
      ...
      <div class="xs:ml-[20px] md:ml-[68px] flex-1">
        ...
        <h3 class="text-[20px] md:text-[24px] leading-[28px] md:leading-[32px] max-w-[715px] mt-[25px] md:mt-[36px]">
          ...
          <div class="relative z-10 gap-5 lg:flex lg:justify-between">
            <div
              ...
              <div class="">
                ...
                <p class="color-1 text-[14px] leading-[19px] mt-[13px] max-w-[460px]">
                  Rainbow provides all the payment solutions you need to succeed
                  - cards, USSD, pay with bank transfer, QR and mobile money
                </p>
              </div>
              <div class="mt-[28px] md:mt-[52px] flex flex-col lg:flex-row sm:items-center">
                <div class="lg:mr-[60px]">
                  <h2
                    class="text-[24px] sm:text-[28px] md:text-[32px] leading-[30px] sm:leading-[38px] md:leading-[44px] font-semibold text-rb-primary-900 font-tomato">
                    Subscriptions
                  </h2>
                  <p class="color-1 text-[14px] leading-[19px] mt-[13px] md:max-w-[200px]">
                ...
                <div class="mt-4 md:mt-0">
                  ...
                  <p class="color-1 text-[14px] leading-[19px] mt-[13px] md:max-w-[200px] md:mx-auto">
    ...
    <div class="section-3 flex mt-[120px] w-full">
      <div class="hidden xs:block">
        <button class="h-[36px] w-[36px] bg-[#FFB084] rounded-full flex items-center justify-center ml-[-18px]">
          <img src="@/assets/images/home/products/lighting-charge.svg" alt="" class="" />
        </button>
        <div class="w-[1.5px] h-full line-gradient"></div>
      </div>
